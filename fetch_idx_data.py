...
def main():
    ...
    if args.use_archive:
        ...
        if archive:
            ...
            output = archive
            # Merge latest browser snapshot spark_path into archive for accurate sparklines
                ...
                try:
                    ...
                    for _k, _v in _snap.get('indices', {}).items():
                        if _v.get('spark_path'):
                            ...
                            # Inject spark_path into both indices and sparklines
                    ...
                    print(f"  Merged spark_path from browser snapshot", file=sys.stderr)
                except Exception as _e:
